...
class Polygon {
  ...
  void addDefaultVertices() {
     ...
     addVertex(new PVector(556, 479));
     addVertex(new PVector(556, 100));
     ...
     addVertex(new PVector(61, 110));
     addVertex(new PVector(61, 120));
  }
  
  void addDefaultVertices2() {
    addVertex(new PVector(589, 73));
    addVertex(new PVector(593, 66));
    addVertex(new PVector(608, 60));
    
     
     //addVertex(new PVector(248, 75));
     //addVertex(new PVector(248, 47));
     //addVertex(new PVector(225, 23));
     //addVertex(new PVector(205, 36));
     //addVertex(new PVector(208, 110));
  }
