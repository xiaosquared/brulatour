class BezierCurve {
  ...
  boolean bDrawLettersOnly = false;
  ...
  public void drawLettersOnly(boolean b) { bDrawLettersOnly = b; }
  public void toggleDrawLettersOnly() { bDrawLettersOnly = !bDrawLettersOnly; }
